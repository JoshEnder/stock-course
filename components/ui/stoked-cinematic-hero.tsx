// components/ui/stoked-cinematic-hero.tsx
"use client";
...
const INJECTED_STYLES = `
  ...
  /* INSIDE THE CARD: White/silver for dark background */
  ...
  /* Deep Physical Card — Stoked dark theme */
  .premium-depth-card {
      background: linear-gradient(145deg, #0d2115 0%, #020617 100%);
      box-shadow:
  ...
  .card-sheen {
      ...
      background: radial-gradient(800px circle at var(--mouse-x, 50%) var(--mouse-y, 50%), rgba(34,197,94,0.05) 0%, transparent 40%);
  ...
  .btn-modern-dark {
      ...
      color: #FFFFFF;
      box-shadow: 0 0 0 1px rgba(34,197,94,0.2), 0 2px 4px rgba(0,0,0,0.6), 0 12px 24px -4px rgba(0,0,0,0.9), inset 0 1px 1px rgba(255,255,255,0.2), inset 0 -3px 6px rgba(0,0,0,0.4);
  }
  .btn-modern-dark:hover {
      transform: translateY(-3px);
      background: linear-gradient(180deg, #22c55e 0%, #16a34a 100%);
      box-shadow: 0 0 0 1px rgba(34,197,94,0.3), 0 6px 12px -2px rgba(34,197,94,0.3), 0 20px 32px -6px rgba(0,0,0,1), inset 0 1px 1px rgba(255,255,255,0.25), inset 0 -3px 6px rgba(0,0,0,0.5);
  }
  .btn-modern-dark:active {
      transform: translateY(1px);
      background: #15803d;
      box-shadow: 0 0 0 1px rgba(34,197,94,0.1), inset 0 3px 8px rgba(0,0,0,0.9), inset 0 0 0 1px rgba(0,0,0,0.5);
  }
...
export function CinematicHero({
  brandName = "Stoked",
  tagline1 = "Learn stocks.",
  tagline2 = "For free.",
  cardHeading = "Knowledge, unlocked.",
  cardDescription = (
    <>
      <span className="text-white font-semibold">Stoked</span> delivers
      bite-sized lessons, personalized learning paths, and gamified streaks —
      making stock market education accessible, interactive, and actually fun.
    </>
  ),
  metricValue = 100,
  metricLabel = "Lessons Available",
  ctaHeading = "Start learning today.",
  ctaDescription =
    "Free, personalized, and interactive stock market education. No experience needed — just curiosity.",
  brandLogo,
  logoUrl = "/",
  onGuestClick,
  onGoogleClick,
      ...
      <div className="cta-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-screen px-4 gsap-reveal pointer-events-auto will-change-transform">
        ...
        <div className="flex flex-col sm:flex-row gap-6">
          ...
          <button
            ...
            className="btn-modern-dark flex items-center justify-center gap-3 px-8 py-4 rounded-[1.25rem] group focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 focus:ring-offset-background"
          >
            {/* Google "G" logo */}
            <svg
              className="w-6 h-6 transition-transform group-hover:scale-105"
            ...
            <div className="text-left">
              <div className="text-[10px] font-bold tracking-wider text-green-300/70 uppercase mb-[-2px]">
                Save your progress
              </div>
              <div className="text-xl font-bold leading-none tracking-tight">
                Log in with Google
      ...
      >
        ...
        >
          ...
          {brandLogo && (
            <a
              href={logoUrl}
              className="stoked-logo-hero absolute top-6 left-6 z-30"
          ...
          <div className="relative w-full h-full max-w-7xl mx-auto px-4 lg:px-12 flex flex-col justify-evenly lg:grid lg:grid-cols-3 items-center lg:gap-8 z-10 py-6 lg:py-0">
            ...
            >
              <div className="relative w-full h-full flex items-center justify-center transform scale-[0.65] md:scale-85 lg:scale-100">
                    ...
                    <div className="relative w-full h-full pt-12 px-5 pb-8 flex flex-col">
                      ...
                      <div className="phone-widget flex justify-between items-center mb-8">
                        <div className="flex flex-col">
                          ...
                          <span className="text-xl font-bold tracking-tight text-white drop-shadow-md">Learning</span>
                        </div>
                        <div className="w-9 h-9 rounded-full bg-green-500/10 text-green-300 flex items-center justify-center font-bold text-sm border border-green-400/20 shadow-lg shadow-black/50">
                          🔥
                        </div>
                      </div>
                      ...
                      <div className="phone-widget relative w-44 h-44 mx-auto flex items-center justify-center mb-8 drop-shadow-[0_15px_25px_rgba(0,0,0,0.8)]">
                        ...
                        <div className="text-center z-10 flex flex-col items-center">
                          ...
                          <span className="text-[8px] text-green-300/50 uppercase tracking-[0.1em] font-bold mt-0.5">{metricLabel}</span>
                        </div>
                      </div>
                      ...
                      <div className="space-y-3">
                        <div className="phone-widget widget-depth rounded-2xl p-3 flex items-center">
                          ...
                          <div className="text-green-400 text-xs font-bold ml-2">+25 XP</div>
                        </div>
                        <div className="phone-widget widget-depth rounded-2xl p-3 flex items-center">
                          ...
                          <div className="text-yellow-400 text-xs font-bold ml-2">Badge</div>
                        </div>
                      </div>
                ...
                <div className="floating-badge absolute flex top-6 lg:top-12 left-[-15px] lg:left-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">7-Day Streak</p>
                    <p className="text-green-300/50 text-[10px] lg:text-xs font-medium">Keep it up!</p>
                  </div>
                </div>

                <div className="floating-badge absolute flex bottom-12 lg:bottom-20 right-[-15px] lg:right-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  <div className="w-8 h-8 lg:w-10 lg:h-10 rounded-full bg-gradient-to-b from-yellow-500/20 to-yellow-900/10 flex items-center justify-center border border-yellow-400/30 shadow-inner">
                    <span className="text-base lg:text-lg drop-shadow-lg" aria-hidden="true">💎</span>
                  </div>
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">Badge Unlocked</p>
                    <p className="text-green-300/50 text-[10px] lg:text-xs font-medium">All-Star achieved</p>
                  </div>
                </div>
            ...
            <div className="card-left-text gsap-reveal order-3 lg:order-1 flex flex-col justify-center text-center lg:text-left z-20 w-full lg:max-w-none px-4 lg:px-0">
              ...
              <p className="hidden md:block text-green-100/70 text-sm md:text-base lg:text-lg font-normal leading-relaxed mx-auto lg:mx-0 max-w-sm lg:max-w-none">
                {cardDescription}
              </p>
            </div>
